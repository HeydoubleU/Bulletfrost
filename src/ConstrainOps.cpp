...
namespace Bullet {
    ...
    namespace Constrain {
        ...
        void constrain_rigid_bodies(  // Create constraint
            ...
            auto* constr = new Constraint(rigid_body_a, rigid_body_b, type, pivot_a, pivot_b, orient_a, orient_b);
            constraint = Amino::Ptr<Constraint>(constr);
        }


        void set_constraint_breaking(Amino::Ptr<Constraint>& constraint, const float& breaking_threshold)
        {
        ...
        void set_constraint_hinge(
            Amino::Ptr<Constraint>& constraint, const Bifrost::Math::float3& axis,
        ...
        void set_constraint_slider(
            ...
            // Setting 'softness' but param is called stiffness because that seems to be the affect.
